...
public class Barrio implements Serializable {
    ...
    private List<UbicacionCementerio> ubicacionCementerioList;
    @OneToMany(mappedBy = "idBarrio")
    ...
    public List<UbicacionCementerio> getUbicacionCementerioList() {
        return ubicacionCementerioList;
    }

    public void setUbicacionCementerioList(List<UbicacionCementerio> ubicacionCementerioList) {
        this.ubicacionCementerioList = ubicacionCementerioList;
    }
    ...
    public String toString() {
        return "jpa.Barrio[ idBarrio=" + idBarrio + " ]";
    }
