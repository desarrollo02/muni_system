...
public class AnularFacController {
    
    private EntityManager em;
    private ComprobanteDAO comprobanteDAO;
    private BaseCalculoDAO baseCalculoDAO;

    public AnularFacController() {
        em = Util.getEm();
    ...
    public void anular(FacturaDTO facturaDTO)throws SQLException{
        em.getTransaction().begin();
            comprobanteDAO.anular(facturaDTO.getNroFactura());
